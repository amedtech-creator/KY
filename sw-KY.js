// KY 주문 시스템 Service Worker v20260418-v10
const CACHE = 'ky-order-v20260418-v10';
const APP_ROOT = '/KY';
const ASSETS = [
  APP_ROOT + '/',
  APP_ROOT + '/index-KY.html',
  APP_ROOT + '/orders-admin-KY.html',
  APP_ROOT + '/orders-KY.html',
  ...
  if(isHtml) {
    event.respondWith((async () => {
      try {
        ...
        return (await caches.match(event.request)) || (await caches.match(APP_ROOT + '/index-KY.html'));
      }
    })());
    return;
  }
...
self.addEventListener('notificationclick', event => {
  ...
  event.waitUntil((async () => {
    ...
    if(clients.openWindow) return clients.openWindow(APP_ROOT + '/index-KY.html');
  })());
});
